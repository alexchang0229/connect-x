...
from competition.week_1.agents import columnator_and_heuritic
from src.main.connect import GameState, ConnectXMatch, ConnectXMatchWithAgents, ConnectXMatchup, ConnectXVisual

from competition.week_1 import weak_1_ncc_play_winning_move
...
# # MATCHUP 2 and 3
matchup_2_3: ConnectXMatchup = ConnectXMatchup(7, 6, 4, player_2_name, player_3_name, player_2, player_3, 2, 1, 10000)
