...
matchup_1_2.generate_report(f"{player_1_name}_vs_{player_2_name}.txt")
...
matchup_1_3.generate_report(f"{player_1_name}_vs_{player_3_name}.txt")
...
matchup_2_3.generate_report(f"{player_2_name}_vs_{player_3_name}.txt")
